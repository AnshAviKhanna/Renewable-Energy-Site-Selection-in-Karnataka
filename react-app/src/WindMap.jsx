...
const districtData = [
  ...
  const suitabilityIndex = [
    { id: 27, name: "Gadag", value: 0.262705 },
    { id: 26, name: "Bengaluru Rural", value: 0.066988 },
    { id: 25, name: "Dakshina Kannada", value: 0.051434 },
    { id: 24, name: "Belagavi (Belgaum)", value: 0.049218 },
    { id: 23, name: "Udupi", value: 0.03665 },
    { id: 22, name: "Kodagu (Coorg)", value: 0.03319 },
    { id: 21, name: "Kalaburagi (Gulbarga)", value: 0.030238 },
    { id: 20, name: "Bidar", value: 0.02936 },
    { id: 19, name: "Raichur", value: 0.027247 },
    { id: 18, name: "Dharwad", value: 0.026917 },
    { id: 17, name: "Chikkamagaluru", value: 0.026745 },
    { id: 16, name: "Kolar", value: 0.026486 },
    { id: 15, name: "Uttara Kannada", value: 0.025469 },
    { id: 14, name: "Hassan", value: 0.025466 },
    { id: 13, name: "Haveri", value: 0.025437 },
    { id: 12, name: "Chamarajanagar", value: 0.024761 },
    { id: 11, name: "Mysuru (Mysore)", value: 0.023365 },
    { id: 10, name: "Koppal", value: 0.023276 },
    { id: 9, name: "Shivamogga (Shimoga)", value: 0.022582 },
    { id: 8, name: "Bengaluru Urban", value: 0.021863 },
    { id: 7, name: "Bijapur (Vijayapura)", value: 0.021513 },
    { id: 6, name: "Bagalkot", value: 0.02054 },
    { id: 5, name: "Tumakuru (Tumkur)", value: 0.020474 },
    { id: 4, name: "Davanagere", value: 0.019924 },
    { id: 3, name: "Mandya", value: 0.019792 },
    { id: 2, name: "Ballari (Bellary)", value: 0.019406 },
    { id: 1, name: "Chitradurga", value: 0.018901 }
  ];
...
const WindMap = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* <h1 className="text-2xl font-bold mb-4">Wind Suitability Map</h1> */}
      <header className="bg-[#4558cf] shadow-md mb-1">
        <div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex items-center mx-4">
          <h1 className="text-2xl font-bold text-white">Wind Suitability Map</h1>
          {/* <nav>
